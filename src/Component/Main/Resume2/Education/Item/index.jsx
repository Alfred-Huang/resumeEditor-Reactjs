            ...
            <Fragment>
                <div  style={{marginBottom: 3,marginLeft: 40}}>
                    <div className="resume-content-title">
                        ...
                        <div  style={{textAlign:"right",fontStyle: "italic", display: "inline-block", width: 190}}>
                            {this.getTime()}
                        </div>
                    </div>
                    <p style={{marginBottom: 3, fontStyle: "italic", width: 524, fontSize: 13,display: "inline-block"}}>{information.major}</p>
                    <p style={{textAlign:"right", fontStyle: "italic", width: 190,marginBottom: 3, display: "inline-block"}}>{information.location}</p>
                    <div style={{lineHeight: 0.7, marginRight: 40, marginTop: 2}}>
                        <div style={{whiteSpace: "pre-wrap",  wordWrap: "break-word"}} dangerouslySetInnerHTML={{__html: HTMLContent}}>
                        </div>
                    </div>
                </div>
            </Fragment>
